...
class TestCore(object):
    ...
    def test_get_axon_morphometrics_with_myelin_mask_simulated_axons_with_axon_as_ellipse(self):
        ...
        self.image_sim_ellipse.generate_axon(axon_radius=10, center=[800, 850], gratio=0.2, plane_angle=70)
        self.image_sim_ellipse.save(self.image_sim_ellipse_path)
    ...
    @pytest.mark.unit
    def test_get_axon_morphometrics_with_myelin_mask_simulated_axons_with_axon_as_ellipse_axongratio_varies_zeroplaneangle(self):
        # Simulated image of axon and myelin to test morphoterics generated by ADS when axon shape is ellipse
        
        self.image_sim_ellipse.generate_axon(axon_radius=50, center=[80, 80], gratio=0.9, plane_angle=0)
        self.image_sim_ellipse.generate_axon(axon_radius=45, center=[180, 180], gratio=0.8, plane_angle=0)
        self.image_sim_ellipse.generate_axon(axon_radius=40, center=[280, 280], gratio=0.7, plane_angle=0)
        self.image_sim_ellipse.generate_axon(axon_radius=35, center=[380, 380], gratio=0.6, plane_angle=0)
        self.image_sim_ellipse.generate_axon(axon_radius=30, center=[480, 480], gratio=0.5, plane_angle=0)
        self.image_sim_ellipse.generate_axon(axon_radius=23, center=[580, 580], gratio=0.4, plane_angle=0)
        self.image_sim_ellipse.generate_axon(axon_radius=18, center=[700, 700], gratio=0.3, plane_angle=0)
        self.image_sim_ellipse.generate_axon(axon_radius=10, center=[800, 850], gratio=0.2, plane_angle=0)
        self.image_sim_ellipse.save(self.image_sim_ellipse_path)
    ...
    @pytest.mark.unit
    def test_get_axon_morphometrics_with_myelin_mask_simulated_axons_with_axon_as_ellipse_axongratio_varies(self):
        # Simulated image of axon and myelin to test morphoterics generated by ADS when axon shape is ellipse
        
        self.image_sim_ellipse.generate_axon(axon_radius=50, center=[80, 80], gratio=0.9, plane_angle=30)
        self.image_sim_ellipse.generate_axon(axon_radius=45, center=[180, 180], gratio=0.8, plane_angle=30)
        self.image_sim_ellipse.generate_axon(axon_radius=40, center=[280, 280], gratio=0.7, plane_angle=30)
        self.image_sim_ellipse.generate_axon(axon_radius=35, center=[380, 380], gratio=0.6, plane_angle=30)
        self.image_sim_ellipse.generate_axon(axon_radius=30, center=[480, 480], gratio=0.5, plane_angle=30)
        self.image_sim_ellipse.generate_axon(axon_radius=23, center=[580, 580], gratio=0.4, plane_angle=30)
        self.image_sim_ellipse.generate_axon(axon_radius=18, center=[700, 700], gratio=0.3, plane_angle=30)
        self.image_sim_ellipse.generate_axon(axon_radius=10, center=[800, 850], gratio=0.2, plane_angle=30)
        self.image_sim_ellipse.save(self.image_sim_ellipse_path)
    ...
    @pytest.mark.unit
    def test_get_axon_morphometrics_with_myelin_mask_simulated_axons_with_axon_as_ellipse_axonplane_varie(self):
        # Simulated image of axon and myelin to test morphoterics generated by ADS when axon shape is ellipse
        
        self.image_sim_ellipse.generate_axon(axon_radius=50, center=[80, 80], gratio=0.6, plane_angle=0)
        self.image_sim_ellipse.generate_axon(axon_radius=45, center=[180, 180], gratio=0.6, plane_angle=10)
        self.image_sim_ellipse.generate_axon(axon_radius=40, center=[280, 280], gratio=0.6, plane_angle=20)
        self.image_sim_ellipse.generate_axon(axon_radius=35, center=[380, 380], gratio=0.6, plane_angle=30)
        self.image_sim_ellipse.generate_axon(axon_radius=30, center=[480, 480], gratio=0.6, plane_angle=40)
        self.image_sim_ellipse.generate_axon(axon_radius=23, center=[580, 580], gratio=0.6, plane_angle=50)
        self.image_sim_ellipse.generate_axon(axon_radius=18, center=[700, 700], gratio=0.6, plane_angle=60)
        self.image_sim_ellipse.generate_axon(axon_radius=10, center=[800, 850], gratio=0.6, plane_angle=70)
        self.image_sim_ellipse.save(self.image_sim_ellipse_path)
    ...
    @pytest.mark.unit
    def test_get_axon_morphometrics_with_myelin_mask_simulated_axons_with_axon_as_ellipse_gratioplane_varies(self):
        # Simulated image of axon and myelin to test morphoterics generated by ADS when axon shape is ellipse
        
        self.image_sim_ellipse.generate_axon(axon_radius=30, center=[80, 80], gratio=0.9, plane_angle=0)
        self.image_sim_ellipse.generate_axon(axon_radius=30, center=[180, 180], gratio=0.8, plane_angle=10)
        self.image_sim_ellipse.generate_axon(axon_radius=30, center=[280, 280], gratio=0.7, plane_angle=20)
        self.image_sim_ellipse.generate_axon(axon_radius=30, center=[380, 380], gratio=0.6, plane_angle=30)
        self.image_sim_ellipse.generate_axon(axon_radius=30, center=[480, 480], gratio=0.5, plane_angle=40)
        self.image_sim_ellipse.generate_axon(axon_radius=30, center=[580, 580], gratio=0.4, plane_angle=50)
        self.image_sim_ellipse.generate_axon(axon_radius=30, center=[700, 700], gratio=0.3, plane_angle=60)
        self.image_sim_ellipse.generate_axon(axon_radius=30, center=[800, 850], gratio=0.2, plane_angle=70)
        self.image_sim_ellipse.save(self.image_sim_ellipse_path)
